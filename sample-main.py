...
MODEL_SAVE_DIR = f'{params.working_dir}/pytorch-models-{params.experiment_name}-{params.model}-{params.prior_update_type}-{param_fn.split("/")[-1].split("Sample")[-1].split(".")[0]}/'
...
inv_net.sample_and_reconstruct_models(100)
